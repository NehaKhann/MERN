        ...
        <section className="section-hero">
          <div className="container grid grid-two-cols">
            <div className="hero-content">
              ...
              <h1>Why Choose Us? </h1>
              <p>
                <b>Expertise</b> : Our team consists of experienced IT
              ...
              <p>
                <b>Customer-Centric Approach</b>: We prioritize your
                satisfaction and provide top-notch support to address your IT
                concerns.
              </p>
              <p>
                <b>Affordability</b> : We offer competitive pricing without
                compromising on the quality of our services.
              </p>
              <p>
                <b>Reliability</b> : Count on us to be there when you need us.
